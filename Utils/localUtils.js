 ...
 */
export const findScoresToMembers = (bill_ids_list, user_vote_list, members_vote_object) => {
    ...
    if ( bill_ids_list.length !== user_vote_list.length || 
    ...
    bill_ids_list.forEach((bill_id, index) => {
        ...
        members_vote_object[bill_id].forEach(element => {
            ...
            if ( AVOID.includes(member_vote) ) {
                score = 0;
            }else if ((member_vote === PRO && user_vote)||
