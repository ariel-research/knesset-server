...
describe('member score for a bill', () =>{
    ...
    test('test the score of member who vote all the bills opposite the user is -100', () =>{
        ...
        member_id = 7;
        let bill_id = 1;
        const score_for_one_bill = findScoresToMembers([bill_id], [true], {[bill_id]: [getPair(member_id, CON)]});
    ...
    test('test the score of member who did not vote for any bills is zero', () =>{
        ...
        const score_of_avoid_vote = findScoresToMembers(SINGEL_BILL_ID, SINGEL_USER_VOTE_PRO, members_vote);
    ...
    test('test the score of member who vote all the bills like the user is 100', () =>{
        ...
        member_id = 7;
        let bill_id = 4;
        const score_for_one_bill = findScoresToMembers([bill_id], [true], {[bill_id]: [getPair(member_id, PRO)]});
    ...
    test('test error - bill ids length not equals to members vote list length', () =>{
        ...
        const bad_using = findScoresToMembers(BILL_IDS, USER_VOTE, empty_members_vote)
