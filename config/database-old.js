...
import { Vote, VoteType, KnessetMember } from "../models/index.js";
...
export const insertBillRow = async (
  ...
  try {
    console.log("insert row: ",billID,billName, knessetNum, billDate);
 ...
 * @param {*} voteID
 */
export const updateVoteId = async (billID, voteID, voteDate) => {
  try {
    await Bill.update(
      { vote_id: voteID,
        vote_date: voteDate,
...
export const getBillsByKnessetNumFromDB = async (knessetNum) => {
  ...
  console.log("knesset in db: ", knessetNum)
